#! /usr/bin/python
"""
Description: collect local account information.

Author: Shayne Cardwell

Date: August 16, 2016

Module: win_local_accounts_statistics.py
"""
import json
import os
import sys
...
def collect_win_local_account_stats(host=node(), is_threaded=0, queue=None):
    """Create usiness logic of the module.
...
def main():
    ...
    print(json.dumps(collect_win_local_account_stats(), indent=4))
