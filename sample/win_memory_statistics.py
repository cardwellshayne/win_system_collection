#! /usr/bin/python
"""
Description: collect memory information.

Author: Shayne Cardwell

Date: August 16, 2016

Module: win_memory_statistics.py
"""
import json
import os
import sys
...
def collect_win_mem_stats(host=node(), is_threaded=0, queue=None):
...
def main():
    ...
    print(json.dumps(collect_win_mem_stats(), indent=4))
