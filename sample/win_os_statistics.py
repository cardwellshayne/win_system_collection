...
def _run_process(reports, host):
    ...
    reports['content']['os_info'] = temp_dict


def collect_os_stats(host=node(), is_threaded=0, queue=None):
...
def main():
    ...
    print(json.dumps(collect_os_stats(), indent=4))
