#! /usr/bin/python
"""
Description: collect bios information.

Author: Shayne Cardwell

Date: August 16, 2016

Module: win_bios_statistics.py
"""
import json
import os
import sys
...
def collect_win_bios_stats(host=node(), is_threaded=0, queue=None):
...
def main():
    ...
    print(json.dumps(collect_win_bios_stats(), indent=4))
